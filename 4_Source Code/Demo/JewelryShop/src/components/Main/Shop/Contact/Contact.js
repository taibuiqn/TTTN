            ...
            <View style={wrapper}>
                <View style={mapContainer}>
                    ...
                    >
                        <MapView.Marker
                            ...
                            title="Jewelry Shop"
                            description="Shop trang sức thơi trang, uy tín và chất lượng"
                        />
                    </MapView>
                ...
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}> 25 Truong Van Thanh, Hiệp Phú Ward, District 9, HoChiMinh City</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0967439321</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>taibuiqn@gmail.com</Text>
                    </View>
                    <View style={[rowInfoContainer, { borderBottomWidth: 0 }]}>
                        <Image source={messageIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 0932134194</Text>
                    </View>
                </View>
            </View>
        );
